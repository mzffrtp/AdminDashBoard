...
const handleActiveMenu = () => setActiveMenu(!activeMenu)
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
        <NavButton  title={"Cart"} customFunc={()=>{}} color={""} icon={<FiShoppingCart />}/>
        <NavButton  title={"Chat"} customFunc={()=>{}} color={""} icon={<BsChatLeft />} dotColor={"orange"}/>
        <NavButton  title={"Notification"} customFunc={()=>{}} color={""} icon={<RiNotification3Line />} dotColor={"pink"}/>
        <TooltipComponent content={"Profile"} position='BottomCenter'>
          <div className='flex items-center gap-2 cursor-pointer p-1rounded-lg hover:bg-light-gray'>
